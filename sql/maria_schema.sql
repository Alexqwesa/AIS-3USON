...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4  COMMENT='web_info inserts table';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8mb4  COMMENT='Departments';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
CREATE TABLE `user_change` (
  `id` int NOT NULL AUTO_INCREMENT,
  `old_login` varchar(16) CHARACTER SET utf8mb4  DEFAULT NULL,
  `p` varchar(32) DEFAULT NULL,
  `new_login` varchar(16) CHARACTER SET utf8mb4  NOT NULL,
...
CREATE TABLE `worker` (
  ...
  `user` varchar(16) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT 'user login',
  `prim` varchar(145) DEFAULT NULL,
