...
class Ui_loginDialog(object):
    def setupUi(self, loginDialog):
        ...
        QtCore.QObject.connect(self.btnEnter, QtCore.SIGNAL("accepted()"), loginDialog.accept)
        QtCore.QObject.connect(self.btnEnter, QtCore.SIGNAL("rejected()"), loginDialog.reject)
        QtCore.QObject.connect(self.pushButton, QtCore.SIGNAL("clicked()"), self.stackedWidget.next_tab)
        QtCore.QMetaObject.connectSlotsByName(loginDialog)

    def retranslateUi(self, loginDialog):
        loginDialog.setWindowTitle(QtWidgets.QApplication.translate("loginDialog", "АИС ТриУСОН", None, -1))
        self.label.setText(QtWidgets.QApplication.translate("loginDialog", "Введите ваши логин пароль для входа в систему АИС ТриУСОН:", None, -1))
        self.label_4.setText(QtWidgets.QApplication.translate("loginDialog", "Логин:", None, -1))
        self.label_3.setText(QtWidgets.QApplication.translate("loginDialog", "Пароль:", None, -1))
        self.label_2.setText(QtWidgets.QApplication.translate("loginDialog", "Статус:", None, -1))
        self.label_5.setText(QtWidgets.QApplication.translate("loginDialog", "Драйвер", None, -1))
        self.label_6.setText(QtWidgets.QApplication.translate("loginDialog", "Порт", None, -1))
        self.label_8.setText(QtWidgets.QApplication.translate("loginDialog", "Сервер:", None, -1))
        self.label_7.setText(QtWidgets.QApplication.translate("loginDialog", "№ отделения", None, -1))
        self.pushButton.setText(QtWidgets.QApplication.translate("loginDialog", "info", None, -1))
