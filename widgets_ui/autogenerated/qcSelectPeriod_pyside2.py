...
# licensing of 'qcSelectPeriod.ui' applies.
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label_63.setText(QtWidgets.QApplication.translate("Form", "Окончание:", None, -1))
        self.label_51.setText(QtWidgets.QApplication.translate("Form", "Начало:", None, -1))
        self.tabs.setTabText(self.tabs.indexOf(self.tab_period), QtWidgets.QApplication.translate("Form", "Произвольный период", None, -1))
        self.label_64.setText(QtWidgets.QApplication.translate("Form", "Месяц:", None, -1))
        self.label_65.setText(QtWidgets.QApplication.translate("Form", "Год:", None, -1))
        self.tabs.setTabText(self.tabs.indexOf(self.tab_month), QtWidgets.QApplication.translate("Form", "Период из списка", None, -1))
