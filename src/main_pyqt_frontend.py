...
elif UI.qtpy == "pyside6":
    from widgets_ui.autogenerated.main_window_pyside6 import Ui_MainWindow
...
class MyAppConnect(QtWidgets.QMainWindow):
    ...
    def ui_init(self):
        ...
        self.tab_services_import = clstab_services_import(self)
        ...
        self.tab_contract_planned = clstab_contract_planned(self)
